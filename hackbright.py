...
def get_project_by_title(title):
    ...
    print("Here is the description for {}: {}".format(row[0], row[1]))
...
def get_grade_by_github_title(github, title):
    ...
    print("User {} on {} project received {} grade.".format(row[0], row[1], row[2]))
...
def assign_grade(github, title, grade):
    ...
    print(f"Successfully added {grade} points for {github}'s {title} project")
